...
class Consumer {
  ...
  #createBatchPayload(messages) {
    ...
    try {
      ...
      /* Do nothing but logging. The batch as a whole remains valid but for the facts that highwatermark won't be there. */
      this.#logger.error(`Error while getting watermark offsets: ${e}`, this.#createConsumerBindingMessageMetadata());
    }
