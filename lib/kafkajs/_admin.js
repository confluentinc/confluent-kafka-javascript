...
class Admin {
  ...
  /**
   * Get the id of the cluster this admin client is connected to.
   *
   ...
   *                                    become available. May be unset (default: 5000).
   *                                    A value of 0 only consults the cache.
   * @returns {Promise<string>} The id of the cluster.
   */
