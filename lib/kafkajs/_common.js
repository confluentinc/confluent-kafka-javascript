 ...
 * ERR_UNKNOWN (-1) code, or with no code at all. Prefer the first error unless it
 * lacks a specific code and the second one has one.
 * @param {{code?: number}|null} primary the preferred error.
 * @param {{code?: number}|null} fallback the alternative error.
 * @returns {{code?: number}|null} the more informative error.
 */
