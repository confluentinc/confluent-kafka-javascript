...
Napi::Array ToV8Array(Napi::Env, std::vector<std::string>);
Napi::Array ToV8Array(Napi::Env, const rd_kafka_error_t **error_list,
                               size_t error_cnt);
Napi::Object UuidToV8Object(Napi::Env, const rd_kafka_Uuid_t* uuid);
Napi::Array ToV8Array(Napi::Env, const rd_kafka_AclOperation_t *, size_t);

Napi::Object ToV8Object(Napi::Env, const rd_kafka_Node_t *);
}  // namespace Util
...
Napi::Object FromListConsumerGroupsResult(
    Napi::Env, const rd_kafka_ListConsumerGroups_result_t *);

// DescribeGroups: response
Napi::Object FromMemberDescription(
    Napi::Env, const rd_kafka_MemberDescription_t *member);
Napi::Object FromConsumerGroupDescription(
    Napi::Env, const rd_kafka_ConsumerGroupDescription_t *desc);
Napi::Object FromDescribeConsumerGroupsResult(
    Napi::Env, const rd_kafka_DescribeConsumerGroups_result_t *);

// DeleteGroups: Response
Napi::Array FromDeleteGroupsResult(
    Napi::Env, const rd_kafka_DeleteGroups_result_t *);

// ListConsumerGroupOffsets: Response
Napi::Array FromListConsumerGroupOffsetsResult(
    Napi::Env, const rd_kafka_ListConsumerGroupOffsets_result_t *result);

// DeleteRecords: Response
Napi::Array FromDeleteRecordsResult(
    Napi::Env, const rd_kafka_DeleteRecords_result_t* result);

// DescribeTopics: Response
Napi::Array FromDescribeTopicsResult(
    Napi::Env, const rd_kafka_DescribeTopics_result_t* result);

// ListOffsets: Response
Napi::Array FromListOffsetsResult(
    Napi::Env, const rd_kafka_ListOffsets_result_t* result);
}  // namespace Admin

namespace TopicPartition {

Napi::Array ToV8Array(Napi::Env, std::vector<RdKafka::TopicPartition *> &);
Napi::Array ToTopicPartitionV8Array(
    Napi::Env, const rd_kafka_topic_partition_list_t *, bool include_offset);
